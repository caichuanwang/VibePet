...
Define the core photo-to-pet generation pipeline for VibePet, including generator selection, generated asset models, local Vision cutout behavior, and UI-agnostic data contracts.
